...
{
    internal class ChooseOneQuestions : QuestionBase
    {
        ...
        public static ChooseOneQuestions AddChooseOneQuestion()
        {
            ...
            Console.WriteLine(" Body of The Question: ");
            question.Body = Console.ReadLine();
            Console.WriteLine(" Marks of The Question:");
            ...
            do
            {
                Console.WriteLine($"Please Enter The Right Answer for Quesion [ 1  || 2 || 3]");
